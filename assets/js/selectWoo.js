...
!(function (a) {
            ...
            return (
                ...
                b.define("select2/utils", ["jquery"], function (a) {
                    ...
                    return (
                        ...
                        (c.isTouchscreen = function () {
                            return void 0 === c._isTouchscreenCache && (c._isTouchscreenCache = "ontouchstart" in document.documentElement), c._isTouchscreenCache;
                        }),
                        c
                    );
                }),
                b.define("select2/results", ["jquery", "./utils"], function (a, b) {
                    ...
                    return (
                        ...
                        (c.prototype.render = function () {
                            var b = a('<ul class="select2-results__options" role="listbox" tabindex="-1"></ul>');
                        ...
                        (c.prototype.highlightFirstItem = function () {
                            var a = this.$results.find(".select2-results__option[data-selected]"),
                        ...
                        (c.prototype.setClasses = function () {
                            ...
                            this.data.current(function (c) {
                                ...
                                b.$results.find(".select2-results__option[data-selected]").each(function () {
                                    var b = a(this),
                                        c = a.data(this, "data"),
                                        e = "" + c.id;
                                    (null != c.element && c.element.selected) || (null == c.element && a.inArray(e, d) > -1) ? b.attr("data-selected", "true") : b.attr("data-selected", "false");
                                });
                            });
                        }),
                        ...
                        (c.prototype.option = function (b) {
                            ...
                            var d = { role: "option", "data-selected": "false", tabindex: -1 };
                            b.disabled && (delete d["data-selected"], (d["aria-disabled"] = "true")),
                                null == b.id && delete d["data-selected"],
                                null != b._resultId && (c.id = b._resultId),
                                b.title && (c.title = b.title),
                                b.children && ((d["aria-label"] = b.text), delete d["data-selected"]);
                            for (var e in d) {
                                var f = d[e];
                                c.setAttribute(e, f);
                            }
                            if (b.children) {
                                ...
                                var i = a(h);
                                this.template(b, h), i.attr("role", "presentation");
                                for (var j = [], k = 0; k < b.children.length; k++) {
                                    var l = b.children[k],
                                        m = this.option(l);
                                    j.push(m);
                                }
                                var n = a("<ul></ul>", { class: "select2-results__options select2-results__options--nested", role: "listbox" });
                                n.append(j), g.attr("role", "list"), g.append(h), g.append(n);
                        ...
                        (c.prototype.bind = function (b, c) {
                            ...
                            this.$results.attr("id", e),
                                ...
                                b.on("results:select", function () {
                                    ...
                                    if (0 !== a.length) {
                                        var b = a.data("data");
                                        "true" == a.attr("data-selected") ? d.trigger("close", {}) : d.trigger("select", { data: b });
                                    }
                                }),
                                b.on("results:previous", function () {
                                    var a = d.getHighlightedResults(),
                                        b = d.$results.find("[data-selected]"),
                                        c = b.index(a);
                                    if (0 !== c) {
                                        var e = c - 1;
                                        0 === a.length && (e = 0);
                                ...
                                b.on("results:focus", function (a) {
                                    a.element.addClass("select2-results__option--highlighted").attr("aria-selected", "true"), d.$results.attr("aria-activedescendant", a.element.attr("id"));
                                }),
                                ...
                                this.$results.on("mouseup", ".select2-results__option[data-selected]", function (b) {
                                    var c = a(this),
                                        e = c.data("data");
                                    if ("true" === c.attr("data-selected")) return void (d.options.get("multiple") ? d.trigger("unselect", { originalEvent: b, data: e }) : d.trigger("close", {}));
                                    d.trigger("select", { originalEvent: b, data: e });
                                }),
                                this.$results.on("mouseenter", ".select2-results__option[data-selected]", function (b) {
                                    var c = a(this).data("data");
                                    d.getHighlightedResults().removeClass("select2-results__option--highlighted").attr("aria-selected", "false"), d.trigger("results:focus", { data: c, element: a(this) });
                                });
                        }),
                        ...
                        (c.prototype.ensureHighlightVisible = function () {
                            ...
                            if (0 !== a.length) {
                                var b = this.$results.find("[data-selected]"),
                                    c = b.index(a),
                ...
                b.define("select2/selection/base", ["jquery", "../utils", "../keys"], function (a, b, c) {
                    ...
                    return (
                        ...
                        (d.prototype.render = function () {
                            var b = a('<span class="select2-selection"  aria-haspopup="true" aria-expanded="false"></span>');
                            return (
                                (this._tabindex = 0),
                        ...
                        (d.prototype._attachCloseHandler = function (b) {
                            a(document.body).on("mousedown.select2." + b.id, function (b) {
                                ...
                                a(".select2.select2-container--open").each(function () {
                                    var b = a(this);
                                    this != d[0] &&
                                        (b.data("element").select2("close"),
                                        setTimeout(function () {
                                            b.find("*:focus").blur(), c.focus();
                                        }, 1));
                                });
                            });
                        }),
                        ...
                        (e.prototype.bind = function (a, b) {
                            ...
                            this.$selection.find(".select2-selection__rendered").attr("id", d).attr("role", "textbox").attr("aria-readonly", "true"),
                                ...
                                this.$selection.on("keydown", function (b) {
                                    !a.isOpen() && b.which >= 48 && b.which <= 90 && a.open();
                                }),
                                this.$selection.on("blur", function (a) {}),
                ...
                b.define("select2/selection/multiple", ["jquery", "./base", "../utils"], function (a, b, c) {
                    ...
                    return (
                        ...
                        (d.prototype.render = function () {
                            ...
                            return a.addClass("select2-selection--multiple"), a.html('<ul class="select2-selection__rendered" aria-live="polite" aria-relevant="additions removals" aria-atomic="true"></ul>'), a;
                        }),
                        ...
                        (d.prototype.selectionContainer = function () {
                            return a('<li class="select2-selection__choice"><span class="select2-selection__choice__remove" role="presentation" aria-hidden="true">&times;</span></li>');
                        }),
                        (d.prototype.focusOnSearch = function () {
                            var a = this;
                            void 0 !== a.$search &&
                                setTimeout(function () {
                            ...
                            if ((this.clear(), 0 !== a.length)) {
                                for (var b = [], d = 0; d < a.length; d++) {
                                    var e = a[d],
                                        ...
                                        g = this.display(e, f);
                                    "string" == typeof g && (g = g.trim()), f.append(g), f.prop("title", e.title || e.text), f.data("data", e), b.push(f);
                                }
                ...
                b.define("select2/selection/search", ["jquery", "../utils", "../keys"], function (a, b, c) {
                    ...
                    return (
                        ...
                        (d.prototype.bind = function (a, b, d) {
                            ...
                            a.call(this, b, d),
                                b.on("open", function () {
                                    e.$search.attr("aria-owns", f), e.$search.trigger("focus");
                                }),
                                b.on("close", function () {
                                    e.$search.val(""), e.$search.removeAttr("aria-activedescendant"), e.$search.removeAttr("aria-owns"), e.$search.trigger("focus");
                                }),
                                ...
                                this.$selection.on("keydown", ".select2-search--inline", function (a) {
                                    ...
                                    } else a.which === c.ENTER && (b.open(), a.preventDefault());
                                });
                            var g = document.documentMode,
                                h = g && g <= 11;
                            this.$selection.on("input.searchcheck", ".select2-search--inline", function (a) {
                                if (h) return void e.$selection.off("input.search input.searchcheck");
                                e.$selection.off("keyup.search");
                            }),
                                this.$selection.on("keyup.search input.search", ".select2-search--inline", function (a) {
                                    if (h && "input" === a.type) return void e.$selection.off("input.search input.searchcheck");
                                    var b = a.which;
                ...
                b.define("select2/data/base", ["../utils"], function (a) {
                    ...
                    return (
                        ...
                        (b.prototype.generateResultId = function (b, c) {
                            var d = "";
                            return (d += null != b ? b.id : a.generateChars(4)), (d += "-result-"), (d += a.generateChars(4)), null != c.id ? (d += "-" + c.id.toString()) : (d += "-" + a.generateChars(4)), d;
                        }),
                        b
                    );
                }),
                b.define("select2/data/select", ["./base", "../utils", "jquery"], function (a, b, c) {
                    ...
                    return (
                        ...
                        (d.prototype._normalizeItem = function (a) {
                            ...
                            return null != a.id && (a.id = a.id.toString()), null != a.text && (a.text = a.text.toString()), null == a._resultId && a.id && (a._resultId = this.generateResultId(this.container, a)), c.extend({}, b, a);
                        }),
                    ...
                    return (
                        ...
                        (c.prototype.bind = function (b, c, d) {
                            ...
                            b.call(this, c, d),
                                ...
                                c.on("close", function () {
                                    e.$search.attr("tabindex", -1), e.$search.removeAttr("aria-activedescendant"), e.$search.removeAttr("aria-owns"), e.$search.val("");
                                }),
                                c.on("focus", function () {
                    ...
                    return (
                        ...
                        (e.prototype._registerEvents = function () {
                            ...
                            this.on("open", function () {
                                ...
                                this.on("query", function (a) {
                                    b.isOpen() || b.trigger("open", {}),
                                        this.dataAdapter.query(a, function (c) {
                                            b.trigger("results:all", { data: c, query: a });
                                        });
                                }),
                                this.on("query:append", function (a) {
                                    this.dataAdapter.query(a, function (c) {
                                        b.trigger("results:append", { data: c, query: a });
                                    });
                                }),
                                this.on("open", function () {
                                    setTimeout(function () {
                                        b.focusOnActiveElement();
                                    }, 1);
                                }),
                                a(document).on("keydown", function (a) {
                                    var c = a.which;
                                    if (b.isOpen()) {
                                        c === d.ESC || c === d.TAB || (c === d.UP && a.altKey)
                                            ? (b.close(), a.preventDefault())
                                            : c === d.ENTER
                                            ? (b.trigger("results:select", {}), a.preventDefault())
                                            : c === d.SPACE && a.ctrlKey
                                            ? (b.trigger("results:toggle", {}), a.preventDefault())
                                            : c === d.UP
                                            ? (b.trigger("results:previous", {}), a.preventDefault())
                                            : c === d.DOWN && (b.trigger("results:next", {}), a.preventDefault());
                                        var e = b.$dropdown.find(".select2-search__field");
                                        e.length || (e = b.$container.find(".select2-search__field")),
                                            c === d.DOWN || c === d.UP
                                                ? b.focusOnActiveElement()
                                                : (e.focus(),
                                                  setTimeout(function () {
                                    ...
                                    } else b.hasFocus() && ((c !== d.ENTER && c !== d.SPACE && c !== d.DOWN) || (b.open(), a.preventDefault()));
                                });
                        }),
                        (e.prototype.focusOnActiveElement = function () {
                            this.isOpen() && !c.isTouchscreen() && this.$results.find("li.select2-results__option--highlighted").focus();
                        }),
                ...
                b.define("jquery.select2", ["jquery", "jquery-mousewheel", "./select2/core", "./select2/defaults"], function (a, b, c, d) {
                    if (null == a.fn.selectWoo) {
                        var e = ["open", "close", "destroy"];
                        a.fn.selectWoo = function (b) {
                    ...
                    return (
                        null != a.fn.select2 && null != a.fn.select2.defaults && (a.fn.selectWoo.defaults = a.fn.select2.defaults),
                        null == a.fn.selectWoo.defaults && (a.fn.selectWoo.defaults = d),
                        (a.fn.select2 = a.fn.select2 || a.fn.selectWoo),
                        c
                    );
                }),
    ...
    return (a.fn.select2.amd = b), (a.fn.selectWoo.amd = b), c;
});
