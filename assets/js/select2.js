                ...
                b.define("select2/results", ["jquery", "./utils"], function (a, b) {
                    ...
                    return (
                        ...
                        (c.prototype.append = function (a) {
                            ...
                            var ml = a.results.length;
                            if (this.options.options.maximumDisplayOptionsLength > 0 && this.options.options.maximumDisplayOptionsLength < ml) {
                                ml = this.options.options.maximumDisplayOptionsLength;
                            }
                            for (var c = 0; c < ml; c++) {
                                var d = a.results[c],
                                    e = this.option(d);
